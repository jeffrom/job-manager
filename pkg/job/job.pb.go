...
var file_job_v1_job_proto_rawDesc = []byte{
	...
	0x73, 0x2a, 0xaa, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x12,
	...
	0x45, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x12, 0x12, 0x0a, 0x0e, 0x53, 0x54, 0x41, 0x54, 0x55,
	0x53, 0x5f, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x06, 0x12, 0x11, 0x0a, 0x0d, 0x53,
	0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x07, 0x42, 0x28,
	0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x65, 0x66,
	0x66, 0x72, 0x6f, 0x6d, 0x2f, 0x6a, 0x6f, 0x62, 0x2d, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x6a, 0x6f, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_job_v1_job_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_job_v1_job_proto_goTypes = []interface{}{
	...
	nil,                         // 5: job.v1.Job.DataEntry
	nil,                         // 6: job.v1.Job.ResultDataEntry
	nil,                         // 7: job.v1.Result.DataEntry
...
var file_job_v1_job_proto_depIdxs = []int32{
	8,  // 0: job.v1.Job.args:type_name -> google.protobuf.Value
	5,  // 1: job.v1.Job.data:type_name -> job.v1.Job.DataEntry
	9,  // 2: job.v1.Job.duration:type_name -> google.protobuf.Duration
	0,  // 3: job.v1.Job.status:type_name -> job.v1.Status
	6,  // 4: job.v1.Job.result_data:type_name -> job.v1.Job.ResultDataEntry
	10, // 5: job.v1.Job.enqueued_at:type_name -> google.protobuf.Timestamp
	1,  // 6: job.v1.Jobs.jobs:type_name -> job.v1.Job
	0,  // 7: job.v1.Result.status:type_name -> job.v1.Status
	7,  // 8: job.v1.Result.data:type_name -> job.v1.Result.DataEntry
	3,  // 9: job.v1.Results.results:type_name -> job.v1.Result
	8,  // 10: job.v1.Job.ResultDataEntry.value:type_name -> google.protobuf.Value
	8,  // 11: job.v1.Result.DataEntry.value:type_name -> google.protobuf.Value
