...
func (x *AckRequestArgs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AckRequestArgs) ProtoMessage() {}

func (x *AckRequestArgs) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_ack_proto_msgTypes[0]
...
// Deprecated: Use AckRequestArgs.ProtoReflect.Descriptor instead.
func (*AckRequestArgs) Descriptor() ([]byte, []int) {
	return file_api_v1_ack_proto_rawDescGZIP(), []int{0}
}

func (x *AckRequestArgs) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AckRequestArgs) GetStatus() v1.Status {
	if x != nil {
		return x.Status
	}
...
func (x *AckRequestArgs) GetData() *_struct.Value {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *AckRequestArgs) GetClaims() []string {
	if x != nil {
		return x.Claims
	}
	return nil
...
type AckRequest struct {
	...
	Acks []*AckRequestArgs `protobuf:"bytes,1,rep,name=acks,proto3" json:"acks,omitempty"`
}
...
func (x *AckRequest) GetAcks() []*AckRequestArgs {
	if x != nil {
		return x.Acks
	}
	return nil
...
var file_api_v1_ack_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x01,
	0x0a, 0x0e, 0x41, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x72, 0x67, 0x73,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x22, 0x38, 0x0a, 0x0a,
	0x41, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x04, 0x61, 0x63,
	0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	0x31, 0x2e, 0x41, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x72, 0x67, 0x73,
...
var file_api_v1_ack_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_v1_ack_proto_goTypes = []interface{}{
	(*AckRequestArgs)(nil), // 0: api.v1.AckRequestArgs
	(*AckRequest)(nil),     // 1: api.v1.AckRequest
	(v1.Status)(0),         // 2: job.v1.Status
	(*_struct.Value)(nil),  // 3: google.protobuf.Value
}
var file_api_v1_ack_proto_depIdxs = []int32{
	2, // 0: api.v1.AckRequestArgs.status:type_name -> job.v1.Status
	3, // 1: api.v1.AckRequestArgs.data:type_name -> google.protobuf.Value
	0, // 2: api.v1.AckRequest.acks:type_name -> api.v1.AckRequestArgs
