...
var file_api_v1_job_proto_rawDesc = []byte{
	...
	0x22, 0xcb, 0x01, 0x0a, 0x0c, 0x41, 0x63, 0x6b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x41, 0x72, 0x67,
	...
	0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x63, 0x6b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x41, 0x72, 0x67, 0x73, 0x2e, 0x44, 0x61,
	...
	0x0a, 0x09, 0x41, 0x63, 0x6b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x28, 0x0a, 0x04, 0x61,
	0x63, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x76, 0x31, 0x2e, 0x41, 0x63, 0x6b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x41, 0x72, 0x67, 0x73, 0x52,
	0x04, 0x61, 0x63, 0x6b, 0x73, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_api_v1_job_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_api_v1_job_proto_goTypes = []interface{}{
	...
	nil,                       // 8: api.v1.AckParamArgs.DataEntry
	(*_struct.Value)(nil),     // 9: google.protobuf.Value
	(*duration.Duration)(nil), // 10: google.protobuf.Duration
	(*job.Jobs)(nil),          // 11: job.v1.Jobs
	(job.Status)(0),           // 12: job.v1.Status
}
var file_api_v1_job_proto_depIdxs = []int32{
	...
	11, // 4: api.v1.EnqueueResponse.jobs:type_name -> job.v1.Jobs
	11, // 5: api.v1.DequeueResponse.jobs:type_name -> job.v1.Jobs
	12, // 6: api.v1.AckParamArgs.status:type_name -> job.v1.Status
	8,  // 7: api.v1.AckParamArgs.data:type_name -> api.v1.AckParamArgs.DataEntry
	5,  // 8: api.v1.AckParams.acks:type_name -> api.v1.AckParamArgs
	9,  // 9: api.v1.AckParamArgs.DataEntry.value:type_name -> google.protobuf.Value
